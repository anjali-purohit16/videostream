...
class UserController extends AdminController
{
    ...
    {
        (new UserModel())->updateStatus($this->readId(), 'suspended');
        $this->logAdminAction('User Suspended', 'Users', 'Suspended user ID ' . $this->readId());
    ...
    {
        (new UserModel())->updateStatus($this->readId(), 'active');
        $this->logAdminAction('User Activated', 'Users', 'Activated user ID ' . $this->readId());
